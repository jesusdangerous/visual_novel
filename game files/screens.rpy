...
define config.main_menu_music = "menumusic.mp3"
...
screen main_menu():
    ...
    imagemap:
        ...
        hotspot(152, 175, 230, 100) action Start()
        hotspot(150, 272, 230, 100) action ShowMenu("load")
        hotspot(140, 372, 350, 110) action ShowMenu("preferences")
        hotspot(141, 489, 290, 100) action ShowMenu("about")
        hotspot(144, 973, 190, 100) action Quit(confirm=True)
        hotspot(1687, 975, 220, 110) action ShowMenu("help")
